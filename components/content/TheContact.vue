...
<template>
    <section class="relative py-20 md:py-[120px]">
        <div class="absolute left-0 z-0 top-0 h-full w-full dark:bg-dark bg-slate-50"></div>
        <div class="absolute left-0 z-0 top-0 h-1/2 w-full dark:bg-dark-700 bg-lime-200 lg:h-[45%] xl:h-1/2"></div>
